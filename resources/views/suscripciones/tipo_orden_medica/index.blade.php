    ...
    <div class="x_panel">
        ...
        <div class="x_title">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <h3>Tipos de Ordenes Medicas</h3>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-12" align="right">
                @can('tipos-ordenes create')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-md-6">
                        <h4 class="modal-title">Nuevo Tipo de Orden Medica</h4>
                    </div>
                    <div class="col-md-6">
                ...
                <form action="{{ url('tiposordenesmedicas') }}" method="POST">
                    @csrf
