        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-md-6">
                        <h4 class="modal-title">Nueva Estado de Caso</h4>
                    </div>
                    <div class="col-md-6">
                ...
                <form action="{{ url('estadoscasos') }}" method="POST">
                    @csrf
