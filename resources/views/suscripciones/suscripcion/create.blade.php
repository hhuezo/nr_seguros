                ...
                <div class="x_content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <select name="OcupacionId" id="OcupacionId" class="form-control">
                                <option value="">Seleccione...</option>
                    ...
                    <div class="row" style="padding-top: 15px!important;">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="number" name="Imc" value="{{ old('Imc') }}" id="Imc" class="form-control"
                                readonly>
                        </div>
                        <div class="col-sm-3">
                    ...
                    <div class="row" style="padding-top: 15px!important;">
                        <div class="col-sm-3">
                            ...
                            <input type="date" name="FechaEntregaDocsCompletos"
                                value="{{ old('FechaEntregaDocsCompletos') }}"
