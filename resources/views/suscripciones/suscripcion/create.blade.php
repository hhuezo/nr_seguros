                                ...
                                <div class="input-group">
                                    <select name="Padecimiento[]" id="Padecimiento" class="form-control select2"
                                        ...
                                        @foreach ($padecimientos as $padecimiento)
                                            <option value="{{ $padecimiento->Id }}"
                                                {{ isset($padecimientos_seleccionados) && in_array($padecimiento->Id, $padecimientos_seleccionados) ? 'selected' : '' }}>
                                                {{ $padecimiento->Nombre }}
                                            </option>
                                        @endforeach
                                    </select>
                                    <span class="input-group-btn">
                                        <button type="button" class="btn btn-primary"
                                            ...
                                            title="Agregar nuevo padecimiento">+</button>
                                    </span>
                                </div>
                            </div>
