            ...
            <table id="datatable" class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $obj->FechaRecepcionResuCIA ? date('d/m/Y', strtotime($obj->FechaRecepcionResuCIA)) : '' }}
                        </td>

                        <td>
                            {{ $obj->FechaEnvioResoCliente ? date('d/m/Y', strtotime($obj->FechaEnvioResoCliente)) : '' }}
                        </td>
                        <td>{{$obj->DiasProcesamientoResolucion ? $obj->DiasProcesamientoResolucion : 0 }}</td>
                        ...
                        <td align="center">
                            ...
                            <a href="#" class="btn btn-info" data-target="#modal-comentario" data-toggle="modal"
                                onclick="getComentarios({{ $obj->Id }})"><i class="fa fa-book fa-lg"></i></a>
                        </td>
                    </tr>
