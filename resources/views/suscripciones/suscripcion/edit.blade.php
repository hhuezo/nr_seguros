...
<div class="x_panel">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-horizontal form-label-left">
                ...
                <div class="x_content">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            ...
                            <input type="date" name="FechaIngreso" value="{{date('Y-m-d', strtotime($suscripcion->FechaIngreso) )}}" class="form-control" autofocus="true">
                        </div>
                        <div class="col-sm-3">
                            ...
                            <select name="CompaniaId" id="CompaniaId" class="form-control">
                                ...
                                <option value="{{$cia->Id}}" {{$suscripcion->CompaniaId == $cia->Id ? 'selected':''}}>{{$cia->Nombre}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-sm-6">
                            <label class="control-label">Gestor</label>
                            <input type="text" name="Gestor" value="{{$suscripcion->Gestor}}" class="form-control" autofocus="true">
                    ...
                    <div class="row" style="padding-top: 15px!important;">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="Contratante" value="{{$suscripcion->Contratante}}" class="form-control">
                        </div>
                        <div class="col-sm-3">
                            <label class="control-label ">Número de Poliza Deuda</label>
                            <input type="text" name="PolizaDeuda" value="{{$suscripcion->PolizaDeuda}}" class="form-control">
                        </div>

                        <div class="col-sm-3">
                            <label class="control-label">Número de Poliza Vida</label>
                            <input type="text" name="PolizaVida" value="{{$suscripcion->PolizaVida}}" class="form-control">
                        </div>
                    </div>
                    <div class="row" style="padding-top: 15px!important;">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="Asegurado" value="{{$suscripcion->Asegurado}}" class="form-control" autofocus="true"
                                oninput="this.value = this.value.toUpperCase()">
                        </div>
                        <div class="col-sm-3">
                            <label class="control-label">Dui</label>
                            <input type="text" name="Dui" rows="1" class="form-control" oninput="this.value = this.value.toUpperCase()" value="{{$suscripcion->Dui}}" data-inputmask="'mask': ['99999999-9']">
                        </div>
                        <div class="col-sm-3">
                            <label class="control-label ">Edad</label>
                            <input type="number" name="Edad" value="{{$suscripcion->Edad}}" class="form-control" oninput="this.value = this.value.toUpperCase()">
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding-top: 15px!important;">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="number" name="SumaAseguradaDeuda" value="{{$suscripcion->SumaAseguradaDeuda}}" class="form-control">
                        </div>
                        <div class="col-sm-3">
                            <label class="control-label ">Suma Asegurada Evaluada vida colectivo usuarios</label>
                            <input type="number" name="SumaAseguradaVida" value="{{$suscripcion->SumaAseguradaVida}}" class="form-control">
                        </div>
                        <div class="col-sm-3">
                            ...
                            <select name="TipoClienteId" id="TipoClienteId" class="form-control">
                                ...
                                <option value="{{$cliente->Id}}" {{$suscripcion->TipoClienteId == $cliente->Id ? 'selected':''}}>{{$cliente->Nombre}}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="row" style="padding-top: 15px!important;">
                        <div class="col-sm-3">
                            ...
                            <input type="text" name="Peso" value="{{$suscripcion->Peso}}" id="Peso" class="form-control" onchange="calculo()">
                        </div>
                        <div class="col-sm-3">
                            <label for="DireccionResidencia" class="form-label">Estatura (m) </label>
                            <input type="text" name="Estatura" value="{{$suscripcion->Estatura}}" id="Estatura" class="form-control" onchange="calculo()">
                        </div>
                        <div class="col-sm-3">
                            <label for="DireccionResidencia" class="form-label">IMC</label>
                            <!-- <input type="checkbox"  class="js-switch" > -->
                            <input type="number" name="Imc" value="{{$suscripcion->Imc}}" id="Imc" class="form-control" readonly>
                        </div>
                        <div class="col-sm-3">
                            <label for="DireccionResidencia" class="form-label">Tipo de IMC</label>
                            <input type="text" name="TipoIMCId" value="{{$suscripcion->TipoIMCId}}" id="TipoImcId">
                            <input type="text" id="TipoIMCDes" class="form-control" readonly value="{{$suscripcion->tipoImc->Nombre ?? ''}}">
                            <!-- <input type="checkbox"  class="js-switch" > -->
                        </div>
                    </div>
                    <div class="row" style="padding-top: 15px!important;">
                        <div class="col-sm-3">
                            ...
                            <input type="text" id="Padecimiento" name="Padecimiento" class="form-control" value="{{$suscripcion->Padecimiento}}">
                            <!-- <input type="checkbox"  class="js-switch" > -->
                        </div>
                        <div class="col-sm-3">
                            ...
                            <select name="TipoOrdenMedicaId" id="TipoOrdenMedicaId" class="form-control">
                                ...
                                <option value="{{$tipo->Id}}" {{$suscripcion->TipoOrdenMedicaId == $tipo->Id ? 'selected' :''}}>{{$tipo->Nombre}}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="row" style="padding-top: 15px!important;">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="date" name="FechaReportadoCia" value="{{date('Y-m-d', strtotime($suscripcion->FechaReportadoCia))}}" id="FechaReportadoCia" class="form-control">
                        </div>
                        <div class="col-sm-3">
                            <label for="DireccionResidencia" class="form-label">Tareas Eva (Sisa)</label>
                            <input type="text" name="TareasEvaSisa" value="{{$suscripcion->TareasEvaSisa}}" id="TareasEvaSisa" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding-top: 15px!important;">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="date" name="FechaResolucion" value="{{date('Y-m-d', strtotime($suscripcion->FechaResolucion))}}" id="FechaResolucion" class="form-control">
                        </div>
                        <div class="col-sm-3">
                            <label for="DireccionResidencia" class="form-label">% ExtraPrima</label>
                            <input type="number" name="ValorExtraPrima" value="{{$suscripcion->ValorExtraPrima}}" id="ValorExtraPrima" class="form-control">
                        </div>
                        <br>
                    ...
                    <div class="row" style="padding-top: 15px!important;">
                        <div class="col-sm-6">
                            ...
                            <select name="EstadoId" id="EstadoId" class="form-control">
                                ...
                                <option value="{{$tipo->Id}}" {{$suscripcion->EstadoId == $tipo->Id ? 'selected':''}}>{{$tipo->Nombre}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
            ...
            <br><br>
            <div style="background-color: lavender; padding: 1%;">
                <label for="">
                    <h4>Comentarios NR </h4>
                </label>
                ...
                <form action="{{ url('suscripciones/agregar_comentario') }}" method="POST" class="forms-sample">
                    ...
                    <div class="row" style="padding-top: 15px!important;">
                        ...
                        <div class="col-sm-6">
                            <label for="DireccionResidencia" class="form-label">Comentarios</label>
                            <textarea name="Comentario" id="Comentario" class="form-control" rows="3"></textarea>
                            <!-- <input type="checkbox"  class="js-switch" > -->
                        </div>
                        <div class="col-sm-3">
                            <label for="DireccionResidencia" class="form-label">Usuario</label>
                            <input type="text" name="Usuario" value="{{$suscripcion->Gestor}}" id="Usuario" class="form-control">
                        </div>
