                ...
                <div class="x_content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <select name="Gestor" class="form-control">
                                ...
                                <option value="{{ $ejecutivo->id }}" {{$suscripcion->GestorId == $ejecutivo->Id ? 'selected':''}}>{{ $ejecutivo->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="float" name="SumaAseguradaDeuda"
                                value="{{ number_format( $suscripcion->SumaAseguradaDeuda,2,'.',',') }}" class="form-control">
                        </div>
                        <div class="col-sm-3">
                            <label class="control-label ">Suma Asegurada Evaluada vida colectivo usuarios</label>
                            <input type="float" name="SumaAseguradaVida"
                                value="{{ number_format($suscripcion->SumaAseguradaVida,2,'.',',') }}" class="form-control">
                        </div>
                        <div class="col-sm-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="number" name="Imc" value="{{ number_format($suscripcion->Imc,2,'.',',') }}" id="Imc"
                    ...
                    <div class="row" style="padding-top: 15px!important;">
                        <div class="col-sm-6">
                            ...
                            <textarea name="ResolucionFinal" id="ResolucionFinal" class="form-control" rows="4">{{ $suscripcion->ResolucionFinal }}</textarea>
                        </div>
                        <div class="col-sm-6 row">
                            <div class="col-sm-12">
                                ...
                                <select name="ResumenGestion" id="ResumenGestion" class="form-control">
                                    ...
                                    <option value="{{ $resumen->Id }}" class="bg-{{ $resumen->Color }}" {{$suscripcion->ResumenGestion == $resumen->Id ? 'selected' :''}}>
                                        {{ $resumen->Nombre }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="date" name="FechaReportadoCia"
                                    value="{{ date('Y-m-d', strtotime($suscripcion->FechaReportadoCia)) }}" id="FechaReportadoCia"
                                    class="form-control">
                            </div>
                            <div class="col-sm-6">
