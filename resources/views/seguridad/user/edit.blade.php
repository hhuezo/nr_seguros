...
<div class="x_panel">
    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <div class="form-horizontal form-label-left">
                        <form method="POST" action="{{ url('seguridad/user/add_rol') }}">
                            <div class="form-group">
                                <div class="col-sm-12">
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <i class="fa fa-trash fa-lg" onclick="modal_delete_rol(<?php echo $obj->id; ?>)"></i>
                                        </td>
                                    </tr>
                                    @endforeach
            ...
            <div class="modal fade" id="modal_delete_rol" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-tipo="1">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form action="{{ url('seguridad/user/delete_rol') }}" method="POST">
