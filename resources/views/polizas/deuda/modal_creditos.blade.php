<div class="modal fade" id="modal_creditos" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-tipo="1">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="{{ url('poliza/vida/usuario_create') }}" method="POST">
                <div class="modal-header">
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                        <h5 class="modal-title" id="exampleModalLabel">Declaracion de Lineas de Credito </h5>
                    </div>
                    ...
                    <div class="box-body">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group row">
                                <label class="control-label col-md-3 col-sm-12 col-xs-12" align="right">Tipo de Cartera</label>
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <select name="TipoCartera" id="TipoCartera1" class="form-control select2" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <input class="form-control" id="TasaCredito1" name="Tasa" type="number" step="any">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-md-3 col-sm-12 col-xs-12" align="right">Tipo de Cartera</label>
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <select name="TipoCartera" id="TipoCartera2" class="form-control select2" >
                                        @foreach($tipoCartera as $obj)
                                        <option value="{{$obj->Id}}">{{$obj->Nombre}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                <label class="control-label col-md-3 col-sm-12 col-xs-12" align="right">Tasa </label>
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <input class="form-control" id="TasaCredito2" name="Tasa" type="number" step="any">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer" align="center">
                    ...
                    <button type="button" id="btn_modal_guardar_creditos" class="btn btn-primary">Aceptar</button>
                </div>
            </form>
