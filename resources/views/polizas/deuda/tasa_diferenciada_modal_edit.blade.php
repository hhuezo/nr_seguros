                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <select name="TipoCalculo" id="TipoCalculo{{$registro->Id}}" class="form-control" required>
                                        ...
                                        <option value="2" {{ $registro->TipoCalculo == '2' ? 'selected' : '' }}>Edad
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group row" id="divEdadDesde{{$registro->Id}}" style="display: none">
                                    <label class="control-label">Edad inicio</label>
                                    <input type="number" step="1" name="EdadDesde" value="{{$registro->EdadDesde}}" class="form-control"
                                        value="">
                                </div>

                                <div class="form-group row" id="divEdadHasta{{$registro->Id}}" style="display: none">
                                    <label class="control-label">Edad final</label>
                                    <input type="number" step="1" name="EdadHasta" value="{{$registro->EdadHasta}}" class="form-control"
                                        value="">
                                </div>

                                <div class="form-group row" id="divTasa{{$registro->Id}}" style="display: none">
                                    <label class="control-label">Tasa</label>
                                    <input type="number" name="Tasa" value="{{$registro->Tasa}}" class="form-control"
                                        value="">
                                </div>
