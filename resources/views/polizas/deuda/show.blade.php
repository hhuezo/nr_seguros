                            ...
                            <form action="{{ url('agregar_credito') }}" method="post">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                        ...
                                        <input id="fechas" type="checkbox" class="js-switch"
                                    ...
                                    <div id="fecha_otorgamiento" style="display: none;">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                            ...
                                            <input type="number" step="any" class="form-control" name="TasaFecha"
                                                id="TasaFecha" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                        ...
                                        <input id="montos" type="checkbox" class="js-switch"
                                            style="margin-left: 25%;" />
                                    </div>
                                    <div id="monto_otorgamiento" style="display: none;">
                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                            <label class="control-label" align="center">Monto Desde</label>
                                            <input type="number" step="0.01" class="form-control" name="MontoDesde"
                                                id="MontoDesde" />
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                            <label class="control-label" align="center">Monto Hasta</label>
                                            <input type="number" step="0.01" class="form-control" name="MontoHasta"
                                                id="MontoHasta" />
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                            <label class="control-label" align="center">Tasa Monto</label>
                                            <input type="number" step="any" class="form-control" name="TasaMonto"
                                                id="TasaMonto" />
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            @foreach ($creditos as $obj)
                                                <tr>
                                                    ...
                                                    <td><a href="" data-target="#modal-delete-{{ $obj->Id }}"
                                                            data-toggle="modal"><i class="fa fa-trash fa-lg"></i></a></td>
                                                </tr>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="form-group row">
                                                    <label class="control-label col-md-3 col-sm-12 col-xs-12"
                                                        ...
                                                        inicial</label>
                                                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                        <input class="form-control" id="EdadInicial" value="1"
                                                            type="text" name="EdadInicial">
                                                    </div>
                                                    <label class="control-label col-md-3 col-sm-12 col-xs-12"
                                                        align="right">Edad
                                                        final</label>
