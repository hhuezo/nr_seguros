...
@section('contenido')
    ...
    <div class="recibo-container" style="overflow-y: scroll">
        <form action="{{ url('poliza/deuda/get_recibo_edit') }}" method="POST" target="_blank">
            @csrf
            <input type="hidden" name="id_deuda_detalle" value="{{ $recibo_historial->PolizaDeudaDetalle }}">
