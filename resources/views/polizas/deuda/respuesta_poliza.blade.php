                        ...
                        <div class="col-md-12 col-sm-12 ">
                            ...
                            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                    <li role="presentation" class="active"><a href="#tab_content6" id="edad-tab" role="tab" data-toggle="tab" aria-expanded="false">Edad Máxima </a>
                                    </li>
                                    <li role="presentation" class=""><a href="#tab_content7" id="responsabilidad-tab5" role="tab" data-toggle="tab" aria-expanded="false">Responsabilidad Máxima </a>
                                    </li>
                                    <li role="presentation" class=""><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Nuevos registros</a>
                                    </li>
