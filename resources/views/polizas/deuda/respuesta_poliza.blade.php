                        ...
                        <div class="col-md-12 col-sm-12 ">
                            ...
                            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                    <li role="presentation" class="active"><a href="#tab_content6" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="true">Edad Terminación</a>
                                    </li>
                                    <li role="presentation" class=""><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="false">Nuevos registros</a>
                                    </li>
                                ...
                                <div id="myTabContent" class="tab-content">
                                    <div role="tabpanel" class="tab-pane active " id="tab_content6" aria-labelledby="home-tab">
                                        <br>
