        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-horizontal form-label-left">
            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                    ...
                    <li role="presentation" class=""><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Estados de Pagos</a>
                    </li>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-sm-12">
                                                                <label class="control-label">Numero Correlativo</label>
                                        ...
                                        <div class="box-body row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                                                ...
                                                <div class="form-group row" style="margin-top:-4%;">
                                                    <label class="control-label " align="right">Tasa por millar </label>
                                                ...
                                                <div class="form-group row" style="margin-top:-4%;">
                                                    <label class="control-label " align="right">Prueba Decimales</label>
                                                ...
                                                <div class="form-group row" style="margin-top:-4%;">
                                                    <label class="control-label " align="right">Prima Calculada</label>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                                <table class="table table-striped jambo_table bulk_action" style="font-size: 13px;">
                                    ...
                                    <tr>
                                        <td>Prima Neta Por Pagar @if ($ultimo_pago)<br>
                                            {{ \Carbon\Carbon::parse($ultimo_pago->FechaInicio)->format('d/m/Y') }}
                                            al
                                            {{ \Carbon\Carbon::parse($ultimo_pago->FechaFinal)->format('d/m/Y') }}
                                            <br>
