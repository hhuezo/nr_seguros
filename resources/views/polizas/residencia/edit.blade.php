                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                                            ...
                                                            <input class="form-control" type="date" name="FechaInicio"
                                                                value="{{ $ultimo_pago ? date('Y-m-d', strtotime($ultimo_pago->FechaFinal)) : '' }}"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                                            <input class="form-control" name="FechaFinal"
                                                                value="{{ $ultimo_pago_fecha_final ? $ultimo_pago_fecha_final : '' }}"
                                                                type="date" required>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                        ...
                                        <div class="modal-body">
                                            <div class="box-body row">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                                                    ...
                                                    <div class="form-group row">
                                                        <input class="form-control" name="FechaInicio" id="FechaInicio"
                                                            type="date" value="{{ session('FechaInicio') }}" required>
                                                    </div>
                                                    ...
                                                    <div class="form-group row" style="margin-top:-5%;">
                                                        ...
                                                        <div class="form-group has-feedback">
                                                            <input type="number" step="any" name="Facturar"
                                                                id="Facturar" class="form-control"
                                                                style="text-align: right;">
                                                            <span class="fa fa-dollar form-control-feedback left"
                                                                aria-hidden="true"></span>
                                                        </div>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="control-label" align="right"
                                                            style="margin-top:-4%;">% Comisión</label>
                                                    ...
                                                    <div class="form-group row" style="margin-top:-4%;">
                                                        ...
                                                        <div class="form-group has-feedback">
                                                            <input class="form-control" name="Retencion" id="Retencion"
                                                                type="number" step="any" style="text-align: right;"
                                                                @if ($residencia->clientes->TipoContribuyente == 1 || $residencia->clientes->TipoContribuyente == 4) readonly @endif>
                                                            <span class="fa fa-dollar form-control-feedback left"
                                                                aria-hidden="true"></span>
                                                        </div>
                                            ...
                                            <div align="center">
                                                ...
                                                <a class="btn btn-primary" data-target="#modal-aplicar"
                                                    data-toggle="modal" onclick="aplicarpago()">Generar Cobro</a>
                                            </div>
