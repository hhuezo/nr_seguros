                ...
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                        ...
                        <li role="presentation" class=""><a href="#tab_content1" id="home-tab" role="tab"
                                data-toggle="tab" aria-expanded="true">Estado de Pagos</a>
                        </li>
                        ...
                        <li role="presentation" class=""><a href="#tab_content3" role="tab" id="creditos-tab"
                                data-toggle="tab" aria-expanded="false">Calculo de Cartera
                                {{ $residencia->NumeroPoliza }}</a>
                        </li>
                        <li role="presentation" class=""><a href="#tab_content5" role="tab" id="recibos-tab"
                                data-toggle="tab" aria-expanded="false">Recibos</a>
                        </li>
                                        ...
                                        <div class="modal-body">
                                            <div class="box-body row">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                                                    <div class="form-group row">
                                                        <label class="control-label col-md-3 col-sm-12 col-xs-12"
                                                            align="right">Fecha Inicio</label>
                                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                                            <input class="form-control" name="FechaInicio"
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                                            ...
                                                            <div class="form-group has-feedback">
                                                                <input type="number" step="any"
                                                                    style="padding-left: 25%;" name="Tasa"
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="control-label col-md-3 col-sm-12 col-xs-12"
                                                            align="right">Prueba Decimales</label>
                                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="control-label col-md-3 col-sm-12 col-xs-12"
                                                            align="right">Prima Calculada</label>
                                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">

                                                            <div class="form-group has-feedback">
                                                                <input type="number" step="any"
                                                                    name="PrimaCalculada" id="PrimaCalculada"
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                                            ...
                                                            <div class="form-group has-feedback">
                                                                <input class="form-control" name="ExtraPrima"
                                                                    type="number" step="any" id="ExtPrima"
                                                                    style="text-align: right;">
                                                                <span class="fa fa-dollar form-control-feedback left"
                                                                    aria-hidden="true"></span>
                                                            </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="control-label col-md-3 col-sm-12 col-xs-12"
                                                            align="right">Descuento</label>
                                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">

                                                            <div class="form-group has-feedback">
                                                                <input class="form-control" name="Descuento"
                                                                    type="number" step="any" id="Descuento"
                                                                    style="text-align: right;">
                                                                <span class="fa fa-dollar form-control-feedback left"
                                                                    aria-hidden="true"></span>
                                                            </div>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="control-label col-md-3 col-sm-12 col-xs-12"
                                                            align="right">Fecha Final</label>
                                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                                            <input class="form-control" name="FechaFinal" id="FechaFinal"
                                                                type="date" value="{{ session('FechaFinal') }}"
                                                                required>
                                                        </div>
                                                    </div>
                                                    <input type="hidden" name="Bomberos" id="Bomberos"
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="control-label col-md-3 col-sm-12 col-xs-12"
                                                            align="right">Impuestos bomberos</label>
                                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">

                                                            <div class="form-group has-feedback">
                                                                <input type="number" step="any"
                                                                    name="ImpuestoBomberos" id="ImpuestoBomberos"
                                                                    class="form-control" readonly
                                                                    style="text-align: right;">
                                                                <span class="fa fa-dollar form-control-feedback left"
                                                                    aria-hidden="true"></span>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="control-label col-md-3 col-sm-12 col-xs-12"
                                                            align="right">Gastos emisión</label>
                                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">

                                                            <div class="form-group has-feedback">
                                                                <input type="number" step="any" name="GastosEmision"
                                                                    id="GastosEmision" value="0"
                                                                    class="form-control" style="text-align: right;">
                                                                <span class="fa fa-dollar form-control-feedback left"
                                                                    aria-hidden="true"></span>
                                                            </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="control-label col-md-3 col-sm-12 col-xs-12"
                                                            align="right">Menos valor CCF de comision</label>
                                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">

                                                            <div class="form-group has-feedback">
                                                                <input type="number" step="any" name="Comision"
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                                            ...
                                                            <div class="form-group has-feedback">
                                                                <input class="form-control" name="ValorDescuento"
                                                                    id="ValorDescuento" type="number" step="any"
                                                                    style="text-align: right;">
                                                                <span class="fa fa-dollar form-control-feedback left"
                                                                    aria-hidden="true"></span>
                                                            </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                                            ...
                                                            <div class="form-group has-feedback">
                                                                <input class="form-control" name="Retencion"
                                                                    id="Retencion" type="number" step="any"
                                                                    style="text-align: right;"
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="control-label col-md-3 col-sm-12 col-xs-12"
                                                            align="right">Valor CCF
                                                            Comisión</label>
                                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">

                                                            <div class="form-group has-feedback">
                                                                <input class="form-control" name="ValorCCF"
                                                                    id="ValorCCFE" type="number" step="any"
                                                                    style="text-align: right;">
                                                                <span class="fa fa-dollar form-control-feedback left"
                                                                    aria-hidden="true"></span>
                                                            </div>
                                                ...
                                                <td>
                                                    <div class="col-md-9 col-sm-9  form-group has-feedback">
                                                        <input type="text" class="form-control has-feedback-left"
                                                            ...
                                                            value="@if ($ultimo_pago) {{ number_format($ultimo_pago->MontoCartera * $valorTasa, 2, '.', ',') }} @else 0 @endif"
                                                            readonly>
                                                        <span class="fa fa-dollar form-control-feedback left"
                                                            aria-hidden="true"></span>
                                                    </div>
                                                ...
                                                <td>
                                                    <div class="col-md-9 col-sm-9  form-group has-feedback">
                                                        <input type="text" class="form-control has-feedback-left"
                                                            ...
                                                            value="@if ($ultimo_pago) {{ number_format($ultimo_pago->MontoCartera * $valorTasa * ($residencia->TasaDescuento / 100), 2, '.', ',') }} @else 0 @endif"
                                                            readonly>
                                                        <span class="fa fa-dollar form-control-feedback left"
                                                            aria-hidden="true"></span>
                                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="col-md-9 col-sm-9  form-group has-feedback">
                                                        <input type="text" class="form-control has-feedback-left"
                                                            style="text-align: right;"
                                                            value="@if ($ultimo_pago) {{ number_format($ultimo_pago->MontoCartera * $valorTasa - $ultimo_pago->MontoCartera * $valorTasa * ($residencia->TasaDescuento / 100), 2, '.', ',') }} @else 0 @endif"
                                                            readonly>
                                                        <span class="fa fa-dollar form-control-feedback left"
                                                            aria-hidden="true"></span>
                                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="col-md-9 col-sm-9  form-group has-feedback">
                                                        <input type="text" class="form-control has-feedback-left"
                                                            style="text-align: right;"
                                                            value="@if ($ultimo_pago) {{ number_format($ultimo_pago->MontoCartera * $valorTasa + $ultimo_pago->ImpuestoBomberos, 2, '.', ',') }} @else 0 @endif"
                                                            readonly>
                                                        <span class="fa fa-dollar form-control-feedback left"
                                                            aria-hidden="true"></span>
                                                    </div>
