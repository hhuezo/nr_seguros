            ...
            <form action="{{ url('polizas/residencia') }}" method="POST" class="forms-sample">
                ...
                <div class="x_content" style="font-size: 12px;">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class=" form-group has-feedback">
                            <input type="number" step="any" name="LimiteGrupo" style="padding-left: 15%; display: block;" id="LimiteGrupo" value="{{ old('LimiteGrupo') }}" class="form-control" required onblur="limiteGrupo(this.value)">
                            <input type="text" step="any" style="padding-left: 15%; display: none;" id="LimiteGrupoTexto"  class="form-control" required onfocus="limiteGrupoTexto(this.value)">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class=" form-group has-feedback">
                            <input type="number" step="any" name="LimiteIndividual" id="LimiteIndividual" style="padding-left: 15%;display: block;" value="{{ old('LimiteIndividual') }}" class="form-control" required onblur="limiteIndividual(this.value)">
                            <input type="text" step="any" style="padding-left: 15%; display: none;" id="LimiteIndividualTexto"  class="form-control" required onfocus="limiteIndividualTexto(this.value)">
                            <span class="fa fa-dollar form-control-feedback left" aria-hidden="true"></span>
                        </div>
                    </div>
                    <div class="col-md-12">
