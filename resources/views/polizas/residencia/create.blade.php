                ...
                <div class="x_content">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                        <div class="form-group">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                <input type="text" name="NumeroPoliza" value="{{ old('NumeroPoliza') }}" class="form-control" required autofocus="true">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                <input type="date" name="VegenciaDesde" value="{{ old('VegenciaDesde') }}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                <input type="date" name="VegenciaHasta" value="{{ old('VegenciaHasta') }}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-12 col-xs-12">Monto cartera</label>
                            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                <input type="number" step="0.01" name="MontoCartera" value="{{ old('MontoCartera') }}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                <input type="number" step="0.01" name="Tasa" value="{{ old('Tasa') }}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                <input type="number" step="0.01" name="Descuento" value="{{ old('Descuento') }}" class="form-control" autofocus="true" data-inputmask="'mask': ['9999-9999']">
                            </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                <input type="number" step="0.01" name="LimiteGrupo" value="{{ old('LimiteGrupo') }}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                <input type="number" step="0.01" name="LimiteIndividual" value="{{ old('LimiteIndividual') }}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                <input type="number" step="0.01" name="ValorPrima" value="{{ old('ValorPrima') }}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                <input type="number" step="0.01" name="GastosEmision" value="{{ old('GastosEmision') }}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-12 col-xs-12">Impuestos bomberos</label>
                            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                <input type="number" step="0.01" name="ImpuestosBomberos" value="{{ old('ImpuestosBomberos') }}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                <input type="number" step="0.01" name="Iva" value="{{ old('Iva') }}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                <input type="number" step="0.01" name="Comision" value="{{ old('Comision') }}" class="form-control">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                <input type="number" step="0.01" name="APagar" value="{{ old('APagar') }}" class="form-control">
                            </div>
                        </div>

                    </div>
                    <!-- modal de calculadora -->
                    <div class="modal fade modal-slide-in-right"  aria-hidden="true" role="dialog" tabindex="-1" id="modal-calculator" >
                        <div class="modal-dialog" style="width: 50%;">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">Estructura CCF de Comisión</h4>
                                </div>
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-12 col-xs-12">Valor de Comisión</label>
                                        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                                            <input type="number" step="0.01" name="ValorComision" id="ValorComision" value="{{ old('ValorComision') }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-12 col-xs-12">Más 13% IVA sobre Comisión</label>
                                        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                                            <input type="number" step="0.01" name="IvaSobreComision" id="IvaSobreComision" value="{{ old('IvaComision') }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-12 col-xs-12">Menos 1% de Retención</label>
                                        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                                            <input type="number" step="0.01" name="Retencion" id="Retencion" value="{{ old('Retencion') }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-12 col-xs-12">Valor CCF de Comisión</label>
                                        <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                                            <input type="number" step="0.01" name="CCFComision" id="CCFComision" value="{{ old('CCFComision') }}" class="form-control">
                                        </div>
                                    </div>
                                </div>
