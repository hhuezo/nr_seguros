<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="x_title">
        <h4>&nbsp;&nbsp; Cálculo de Cartera
            {{ $desempleo->cliente->Nombre }}<small></small>
        </h4>
    ...
    <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
        <table class="table table-striped jambo_table bulk_action" style="font-size: 13px;">
            <thead>
                <tr>
                    <th>{{ $desempleo->aseguradora->Nombre }} <br>
                        {{ $desempleo->cliente->Nombre }} <br>
                        N° Póliza: {{ $desempleo->NumeroPoliza }} <br>
                        Vigencia:
                        {{ \Carbon\Carbon::parse($desempleo->VigenciaDesde)->format('d/m/Y') }}
                        al
                        {{ \Carbon\Carbon::parse($desempleo->VigenciaHasta)->format('d/m/Y') }}
                        <br>
    ...
    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
        <table class="table table-striped jambo_table bulk_action" style="font-size: 12px;">
            ...
            <tr>
                ...
                <td style="text-align: right;"><span class="fa fa-dollar " aria-hidden="true"></span></td>
                <td style="text-align: right;">
                    <label class="label-control has-feedback-left" style="text-align: right;">{{ $desempleo->Tasa }} </label>
                </td>
                <td></td>
            </tr>
            ...
            <tr>
                <td>(-) Descuento Rentabilidad {{ $desempleo->TasaDescuento }}%</td>
                <td style="text-align: right;"><span class="fa fa-dollar " aria-hidden="true"></span></td>
                <td style="text-align: right;">
