...
@section('contenido')
    ...
    <div class="page-title">
        <div class="title_left">
            <h3>Póliza de desempleo / {{ $desempleo->NumeroPoliza }}</h3>
        </div>
        ...
        <div class="title_right text-right">
            ...
            <a href="{{ url('polizas/desempleo') }}/{{ $desempleo->Id }}/edit" class="btn btn-primary" type="button"><i
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                @foreach ($desempleo->desempleo_tipos_cartera as $tipo)
                                    ...
                                    @include('polizas.desempleo.desempleo_tasa_diferenciada.tipo_cartera_modal_edit')
    ...
    <div class="modal fade" id="modal-add-tipo-cartera" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{ url('polizas/desempleo/agregar_tipo_cartera') }}/{{ $desempleo->Id }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="modal-delete-tipo-cartera" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{ url('polizas/desempleo/delete_tipo_cartera') }}" method="POST">
                    @csrf
                    <div class="modal-header">
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
    ...
    <div class="modal fade" id="modal-tasa-diferenciada" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{ route('tasa_diferenciada_desempleo.store') }}" method="POST">
                    @csrf
                    <div class="modal-header">
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
    ...
    <div class="modal fade" id="modal-delete-tasa-diferenciada" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{ url('polizas/desempleo/delete_tasa_diferenciada') }}" method="POST">
                    @csrf
                    <div class="modal-header">
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
