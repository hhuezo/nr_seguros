                    ...
                    <div class="col-sm-12" style="padding: 0% !important">
                        ...
                        <div class="item form-group col-sm-12 col-md-6 col-lg-6">
                            ...
                            <select name="Productos" id="Productos" class="form-control select2" style="width: 100%"
                                required>
                                <option value="" disabled {{ old('Productos') ? '' : 'selected' }}>Seleccione...
                                </option>
                        ...
                        <div class="item form-group col-sm-12 col-md-6 col-lg-6">
                            ...
                            <select name="Planes" id="Planes" class="form-control select2" style="width: 100%" required>
                                <option value="" disabled {{ old('Planes') ? '' : 'selected' }}>Seleccione...
                                </option>
                                @foreach ($planes as $obj)
                                    <option value="{{ $obj->Id }}" {{ old('Planes') == $obj->Id ? 'selected' : '' }}>
                                        {{ $obj->Nombre }}
                                    </option>
                                @endforeach
                            </select>
