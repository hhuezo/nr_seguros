<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-recibo-{{ $obj->Id }}">
    ...
    <form method="POST" action="{{ url('poliza/desempleo/recibo', $obj->Id) }}" target="_blank">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <input type="hidden" value="{{ $desempleo->Id }}" name="Desempleo" id="Desempleo" class="form-control">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Eliminar Registro de Cartera</h4>
                </div>
                <div class="modal-body">
