    ...
    <div class="x_panel">
        ...
        <div class="row">
                    ...
                    <tbody>
                        @foreach ($tipos_cartera as $tipo)
                            <tr>
                                ...
                                @include('polizas.desempleo.complementario.modal_subir_cartera')
                                @include('polizas.desempleo.complementario.modal_eliminar_cartera')
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="text-align: right;">
                <form method="POST" action="{{ url('polizas/desempleo/validar_poliza_complementario') }}/{{ $desempleo->Id }}">
                    @csrf
