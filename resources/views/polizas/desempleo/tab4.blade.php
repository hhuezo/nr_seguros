        ...
        <tbody>
            @foreach ($detalle as $obj)
                <tr>
                    ...
                    <td style="text-align: center;">{{ $desempleo->NumeroPoliza }}</td>
                    ...
                    <td style="text-align: center;">
                        ...
                        @if ($obj->Activo == 1)
                            ...
                            @endif
                                @csrf
                                <input type="hidden" value="{{ $desempleo->Id }}" name="Desempleo">
                                <input type="hidden" value="{{ $obj->Id }}" name="DesempleoDetalle">
                                <button class="btn btn-success" style="margin-top: 15px" disabled title="proximamente">
...
<div class="modal fade " id="modal_editar_pago" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form method="POST" action="{{ url('polizas/desempleo/edit_pago') }}">
