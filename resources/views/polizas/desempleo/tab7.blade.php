                    ...
                    <tr>
                        ...
                        <td>
                            <div style=" display: flex;gap: 10px; align-items: center;">
                                @can('desempleo historico pago view')
                                ...
                                @endcan
                                @can('desempleo historico pago export')
                                <form action="{{url('polizas/desempleo/exportar_historial')}}" method="post" style="display:inline-block;">
                                    @csrf
