                        ...
                        <div class="form-horizontal" style="font-size: 12px;">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                            <input class="form-control" name="NumeroPoliza" id="NumeroPoliza" type="text"
                                                value="{{ old('NumeroPoliza') }}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="control-label col-md-3 col-sm-12 col-xs-12"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                            <input class="form-control" name="MontoCartera" id="MontoCartera"
                                                type="number" step="any" value="{{ old('MontoCartera') }}"
                                                required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                            <input class="form-control" name="SubTotal" type="number" id="SubTotal"
                                                step="any" value="{{ old('PrimaTotal') }}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                            <input class="form-control" name="ExtraPrima" type="number" step="any"
                                                id="ExtPrima" value="{{ old('ExtraPrima') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="control-label col-md-3 col-sm-12 col-xs-12" align="right">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                            <input class="form-control" name="PrimaTotal" type="number" step="any"
                                                id="PrimaTotal" value="{{ old('PrimaToal') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                            <input class="form-control" name="PrimaDescontada" type="number"
                                                step="any" id="PrimaDescontada" value="{{ old('ExtraPrima') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group row">
                                        <label class="control-label col-md-3 col-sm-12 col-xs-12" align="right">Tipo de
                                            Cobro</label>
                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                            <select name="TipoCobro" class="form-control select2" id="TipoCobro"
                                                style="width: 100%" required>
                                                <option value="">Seleccione...</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                            <input class="form-control" name="ValorDescuento" id="ValorDescuento"
                                                type="number" step="any" value="{{ old('ValorDescuento') }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                            <input class="form-control" name="IvaSobreComision" id="IvaSobreComision"
                                                type="number" step="any" value="{{ old('IvaSobreComision') }}">
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group" align="center">
                                    ...
                                    <a href="{{ url('poliza/deposito_plazo') }}"><button type="button"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function calculoSubTotal() {
                if (document.getElementById('MontoCartera').value != "" && document.getElementById('Tasa').value !=
                    "") {
                    if (document.getElementById('Anual').checked == false && document.getElementById('Mensual')
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Oops...',
                            text: 'Debe seleccionar el tipo de tasa',
                            timer: 1500
                        })
                    } else {
                        var monto = document.getElementById('MontoCartera').value;
            ...
            function calculoExtraprima() {
                if (document.getElementById('SubTotal').value != "" && document.getElementById('ExtPrima').value !=
                    "") {
            ...
            function calculoPrimaDescontada() {
                if (document.getElementById('PrimaTotal').value != "" && document.getElementById('Descuento')
                    .value != "") {
            ...
            $('#PrimaDescontada').change(function() {
                calculoPrimaDescontada();
            })
            ...
            function calculoPrimaDescontada() {
                if (document.getElementById('TasaComision').value != "" && document.getElementById('PrimaDescontada')
                    .value != "") {
