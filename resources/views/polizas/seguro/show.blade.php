                    ...
                    <div class="form-horizontal">
                        <div class="col-sm-6" style="background-color: lightgrey; padding: 12px; border-radius: 15px;">
                            ...
                            <select name="Oferta" id="Oferta" class="form-control" onchange="select_oferta(this)">
                                ...
                                <option value="{{$off->Id}}" {{$off->Id == $poliza_seguro->Oferta ? 'selected':''}}>{{$off->clientes->Nombre}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <select name="FormaPago" id="FormaPago" class="form-control" required>
                                ...
                                <option value="{{ $loop->index }}" {{$loop->index == $poliza_seguro->FormaPago ? 'selected':''}}>{{ $pago == '' ? 'Seleccione...' : $pago }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="form-horizontal">
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="NumeroPoliza" class="form-control" required value="{{$poliza_seguro->NumeroPoliza}}">
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <select name="EstadoPoliza" id="EstadoPoliza" class="form-control" required>
                                ...
                                <option value="{{ $estado->Id }}" {{$estado->Id == $poliza_seguro->EstadoPoliza ? 'selected':''}}>{{ $estado->Nombre }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="item form-group col-sm-12 col-md-6 col-lg-6">
                            ...
                            <select name="Productos" id="Productos" class="form-control select2" style="width: 100%" required>
                                ...
                                <option value="{{ $obj->Id }}" {{$obj->Id == $poliza_seguro->Productos ? 'selected':''}}>{{ $obj->Nombre }}</option>
                                @endforeach
                            </select>
                        </div>
                        <!-- Planes -->
                        <div class="item form-group col-sm-12 col-md-6 col-lg-6">
                            ...
                            <select name="Planes" id="Planes" class="form-control select2" style="width: 100%" required>
                                ...
                                <option value="{{ $obj->Id }}" {{$obj->Id == $poliza_seguro->Planes ? 'selected':''}}>{{ $obj->Nombre }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="IdCliente" id="IdCliente" class="form-control" id="IdCliente" required value="{{$poliza_seguro->clientes->Dui ?? ''}}">
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <select name="Cliente" id="Cliente" class="form-control select2" style="width: 100%" required>
                                ...
                                <option value="{{ $obj->Id }}" {{$obj->Id == $poliza_seguro->clientes->Id ? 'selected':''}}>{{ $obj->Nombre }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="MotivoCancelacion" class="form-control" value="{{$poliza_seguro->MotivoCancelacion}}">
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <select name="CodCancelacion" id="CodCancelacion" class="form-control select2" style="width: 100%" required>
                                <option value="" selected disabled>Seleccione...</option>
                ...
                <div class="row">
                    <div class="form-horizontal">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="Observacion" class="form-control" value="{{$poliza_seguro->Observacion}}">
                        </div>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="col-sm-6">
                            ...
                            <select name="DepartamentoNr" id="DepartamentoNr" class="form-control select2" style="width: 100%">
                                ...
                                <option value="{{ $obj->Id }}" {{$obj->Id == $poliza_seguro->Departamento ? 'selected':''}}>{{ $obj->Nombre }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="col-sm-6">
                            ...
                            <select name="EjecutivoCia" id="EjecutivoCia" class="form-control select2" style="width: 100%">
                                ...
                                <option value="{{ $obj->Id }}" {{$obj->Id == $poliza_seguro->EjecutivoCia ? 'selected' :''}}>{{ $obj->Nombre }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="col-sm-6">
                            ...
                            <select name="Deducible" id="Deducible" class="form-control select2" style="width: 100%">
                                ...
                                <option value="{{ $obj->Id }}" {{$obj->Id == $poliza_seguro->Deducible ? 'selected' :''}}>{{ $obj->Nombre }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>No</td>
                        @endif
                        <td><input type="text" class="form-control" onchange="update_cobertura({{ $obj->Id }}, event)" value="{{$obj->Valor}}"></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>No</td>
                        @endif
                        <td><input type="text" class="form-control" onchange="update_datos_tecnicos({{$obj->Id}}, event)" value="{{$obj->Valor}}"></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
