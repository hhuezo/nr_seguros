<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="x_title">
        <h4>&nbsp;&nbsp; Cálculo de Cartera
            {{ $poliza_vida->cliente->Nombre }}<small></small>
        </h4>
    ...
    <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
        <table class="table table-striped jambo_table bulk_action" style="font-size: 13px;">
            <thead>
                <tr>
                    <th>{{ $poliza_vida->aseguradora->Nombre }} <br>
                        {{ $poliza_vida->cliente->Nombre }} <br>
                        N° Póliza: {{ $poliza_vida->NumeroPoliza }} <br>
                        Vigencia:
                        {{ \Carbon\Carbon::parse($poliza_vida->VigenciaDesde)->format('d/m/Y') }}
                        al
                        {{ \Carbon\Carbon::parse($poliza_vida->VigenciaHasta)->format('d/m/Y') }}
                        <br>
    ...
    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
        <table class="table table-striped jambo_table bulk_action" style="font-size: 12px;">
            ...
            <tr>
                <td>(-) Descuento Rentabilidad {{ $poliza_vida->TasaDescuento }}%</td>
                <td style="text-align: right;"><span class="fa fa-dollar " aria-hidden="true"></span></td>
                <td style="text-align: right;">
