                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                            <input class="form-control" name="LimiteMaximoDeclaracion"
                                                ...
                                                value="{{ $vida->LimiteMaximoDeclaracion }}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                            <input class="form-control" name="LimiteIntermedioDeclaracion"
                                                ...
                                                value="{{ $vida->LimiteIntermedioDeclaracion }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                            <input class="form-control" name="EdadTerminacion" id="EdadTerminacion"
                                                type="number" value="{{ $vida->EdadTerminacion }}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="control-label col-md-3 col-sm-12 col-xs-12" align="right">Edad
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                            <input class="form-control" name="EdadMaxTerminacion" id="EdadMaxTerminacion"
                                                type="number" value="{{ $vida->EdadMaxTerminacion }}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="control-label col-md-3 col-sm-12 col-xs-12" align="right">Edad
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                            <input class="form-control" name="EdadIntermediaTerminacion"
                                                ...
                                                value="{{ $vida->EdadIntermediaTerminacion }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="Usuarios">
                                    ...
                                    <div align="right">
                                        <a class="btn btn-primary"
                                            onclick="modal_usuario(<?php echo $vida->Id; ?>,document.getElementById('NumeroPoliza').value, document.getElementById('Tasa').value, document.getElementById('Mensual').checked, document.getElementById('Anual').checked);"><i
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                            <input class="form-control" name="ImpresionRecibo" id="ImpresionRecibo"
                                                type="text"
                                                @if ($detalle_last) value="{{ \Carbon\Carbon::parse($detalle_last->ImpresionRecibo)->format('d/m/Y') }}" @endif
                                                readonly>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                            <input class="form-control" name="EnvioCartera" id="EnvioCartera"
                                                type="text"  @if ($detalle_last)  value="{{ $detalle_last->EnvioCartera }}" @endif>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                            ...
                                            @if ($detalle_last)  value="{{ $detalle_last->EnvioPago }}" @endif>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                            <input class="form-control" name="PagoAplicado" id="PagoAplicado"
                                                type="text" @if ($detalle_last) value="{{ $detalle_last->PagoAplicado }}" @endif>
                                        </div>
                                    </div>
                                </div>
