                            ...
                            <div class="col-md-12 col-sm-12 ">
                                ...
                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                        ...
                                        <li role="presentation" class=""><a href="#tab_maxima" id="maxima-tab"
            ...
            <div class="modal" id="modal-primer-ingreso" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form method="POST"
                            action="{{ url('polizas/vida/store_poliza_primara_carga') }}/{{ $poliza_vida->Id }}">
                            @csrf
