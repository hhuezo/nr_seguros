                        ...
                        <div class="col-md-12 col-sm-12 ">
                            ...
                            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                    ...
                                    <li role="presentation" class=""><a href="#tab_extraprimados" role="tab" id="profile-tab2" data-toggle="tab" aria-expanded="false">Extraprimados
                                            <br>
                                            excluidos</a>
                                    </li>
                                ...
                                <div id="myTabContent" class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="tab_edad"
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12" align="right" id="btn_expo"
                                            ...
                                            <form
                                                action="{{ url('exportar/desempleo/registros_edad_maxima') }}/{{ $poliza_vida->Id }}"
                                                method="POST">
                                                @csrf
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="tab_inscripcion"
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12" align="right" id="btn_expo"
                                            ...
                                            <form
                                                action="{{ url('exportar/desempleo/registros_responsabilidad_maxima') }}/{{ $poliza_vida->Id }}"
                                                method="POST">
                                                @csrf
                                                <button style="text-align: right;" class="btn btn-success">Descargar
                                                    Excel</button>
                                        ...
                                        <div role="tabpanel" class="tab-pane  " id="tab_nuevos" aria-labelledby="home-tab">
                                            <div class="col-md-12 col-sm-12" align="right">
                                                <form method="POST"
                                                    action="{{ url('exportar/desempleo/nuevos_registros') }}/{{ $poliza_vida->Id }}">
                                                    @csrf
                                        ...
                                        <div role="tabpanel5" class="tab-pane" id="tab_eliminados"
                                            ...
                                            <div class="col-md-12 col-sm-12" align="right">
                                                <form method="POST"
                                                    action="{{ url('exportar/desempleo/registros_eliminados') }}/{{ $poliza_vida->Id }}">
                                                    @csrf
                                                    <button class="btn btn-success"
                                        ...
                                        <div role="tabpanel5" class="tab-pane" id="tab_rehabilitados"
                                            ...
                                            <div class="col-md-12 col-sm-12" align="right">
                                                <form method="POST"
                                                    action="{{ url('exportar/desempleo/registros_rehabilitados') }}/{{ $poliza_vida->Id }}">
                                                    @csrf
                                                    <button class="btn btn-success"
