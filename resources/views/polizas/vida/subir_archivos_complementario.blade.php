    ...
    <div class="x_panel">
        ...
        <div class="row">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        @foreach ($poliza_vida_tipo_cartera as $obj)
                            ...
                            @include('polizas.vida.complementario.add_cartera')
                            @include('polizas.vida.complementario.add_cartera_fede')
                            @include('polizas.vida.complementario.modal_eliminar_cartera')
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="text-align: right;">
                <form method="POST" action="{{ url('polizas/vida/validar_poliza_recibos') }}/{{ $poliza_vida->Id }}">
                    @csrf
