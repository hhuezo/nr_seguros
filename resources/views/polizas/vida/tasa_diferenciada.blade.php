                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr class="tarea warning-row">
                            <td>
                                <span class="expand-icon">▼</span> {{ $tipo->catalogo_tipo_cartera?->Nombre ?? '' }}
                            </td>
                            <td>
                            ...
                            <td> <button class="btn btn-primary" data-target="#modal-tipo-cartera-edit-{{ $tipo->Id }}"
                                    data-toggle="modal"><i class="fa fa-edit"></i></button>
                                <button class="btn btn-danger" data-target="#modal-delete-tipo-cartera"
                                    data-toggle="modal" onclick="show_modal_delete_tipo_cartera({{ $tipo->Id }})"><i
                                    ...
                                    <table class="table table-sm table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="primary-row">
                                                @if ($tipo->TipoCalculo == 1)
                                                <td>
                                                    {{ $tasa_diferenciada->FechaDesde ? date('d/m/Y',
                                                    strtotime($tasa_diferenciada->FechaDesde)) : 'Sin fecha' }}
                                                </td>
                                                <td>
                                                    {{ $tasa_diferenciada->FechaHasta ? date('d/m/Y',
                                                    strtotime($tasa_diferenciada->FechaHasta)) : 'Sin fecha' }}
                                                </td>
                                                @endif

                                                @if ($tipo->TipoCalculo == 2)
                                                <td>{{ $tasa_diferenciada->MontoDesde }} Años</td>
                                                <td>{{ $tasa_diferenciada->MontoHasta }} Años</td>
                                                @endif
...
<div class="modal fade" id="modal-delete-tipo-cartera" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true" data-tipo="1">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
...
<div class="modal fade" id="modal-tasa-diferenciada" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true" data-tipo="1">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="box-body">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <input type="hidden" id="tipoCalculoIngreso" name="TipoCalculoIngreso" class="form-control">
                            ...
                            <div class="form-group row">
                                ...
                                <input type="number" name="Tasa" step="any" value="{{$vida->Tasa}}" class="form-control" required>
                            </div>
