...
<div class="x_panel">
    <div class="x_title">
        <div class="col-md-6 col-sm-6 col-xs-12">
            <h3>Parentescos de beneficiarios</h3>
        </div>
...
<div class="modal fade" id="modal-create" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" action="{{ url('catalogo/parentesco_beneficiario') }}">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Nuevo parentesco de beneficiario</h4>
                </div>
...
@foreach ($parentescos as $obj)
    <div class="modal fade" id="modal-edit-{{ $obj->Id }}" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" action="{{ url('catalogo/parentesco_beneficiario/' . $obj->Id) }}">
                @csrf
                @method('PUT')
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Editar parentesco de beneficiario</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Nombre</label>
            ...
            <form method="POST" action="{{ url('catalogo/parentesco_beneficiario/' . $obj->Id) }}">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Eliminar parentesco de beneficiario</h4>
                    </div>
                    <div class="modal-body">
