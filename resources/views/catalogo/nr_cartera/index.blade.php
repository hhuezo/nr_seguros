    ...
    <div class="x_panel">
        ...
        <div class="x_title">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12" align="right">
                {{-- <a href="{{ url('catalogo/nr_cartera/create/') }}"><button class="btn btn-info float-right"> <i
                        ...
                        @foreach ($nr_cartera as $obj)
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    @can('edit users')
                                        {{-- <a href="{{ url('catalogo/nr_cartera') }}/{{ $obj->Id }}/edit"
                            ...
                            @include('catalogo.nr_cartera.edit')
                        @endforeach
                    </tbody>
                </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-md-6">
                        <h4 class="modal-title">Nueva Tipo de Cartera NR</h4>
                    </div>
                    <div class="col-md-6">
                ...
                <form action="{{ url('catalogo/nr_cartera') }}" method="POST">
                    @csrf
