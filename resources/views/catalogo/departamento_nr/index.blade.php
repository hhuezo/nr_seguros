    ...
    <div class="x_panel">
        ...
        <div class="x_title">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <h3>Departamentos NR </h3>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-12" align="right">
                @can('departamento-nr create')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-md-6">
                        <h4 class="modal-title">Nueva Departamento NR</h4>
                    </div>
                    <div class="col-md-6">
                ...
                <form action="{{ url('catalogo/departamento_nr') }}" method="POST">
                    @csrf
