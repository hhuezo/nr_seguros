    ...
    <div class="x_panel">
        ...
        <div class="x_title">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12" align="right">
                {{-- <a href="{{ url('catalogo/tipo_poliza/create/') }}"><button class="btn btn-info float-right"> <i
                        ...
                        @foreach ($tipo_poliza as $obj)
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    @can('edit users')
                                        {{-- <a href="{{ url('catalogo/tipo_poliza') }}/{{ $obj->Id }}/edit"
                            ...
                            @include('catalogo.tipo_poliza.modal')
                            @include('catalogo.tipo_poliza.edit')
                        @endforeach
                    </tbody>
                </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-md-6">
                        <h4 class="modal-title">Nuevo Tipo de Póliza</h4>
                    </div>
                    <div class="col-md-6">
