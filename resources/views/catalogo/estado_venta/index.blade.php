                ...
                <table id="datatable" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        @foreach ($estado_venta as $obj)
                            ...
                            @include('catalogo.estado_venta.edit')
                        @endforeach
                    </tbody>
                </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-md-6">
                        <h4 class="modal-title">Nuevo Estado Venta</h4>
                    </div>
                    <div class="col-md-6">
                ...
                <form action="{{ url('catalogo/estado_venta') }}" method="POST">
                    @csrf
