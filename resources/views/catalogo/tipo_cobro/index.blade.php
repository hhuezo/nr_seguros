    ...
    <div class="x_panel">
        ...
        <div class="x_title">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12" align="right">
                {{-- <a href="{{ url('catalogo/tipo_cobro/create/') }}"><button class="btn btn-info float-right"> <i
                        ...
                        @foreach ($tipo_cobro as $obj)
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    @can('edit users')
                                        {{-- <a href="{{ url('catalogo/tipo_cobro') }}/{{ $obj->Id }}/edit"
                            ...
                            @include('catalogo.tipo_cobro.modal')
                            @include('catalogo.tipo_cobro.edit')
                        @endforeach
                    </tbody>
                </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-md-6">
                        <h4 class="modal-title">Nuevo Tipo de Cobro</h4>
                    </div>
                    <div class="col-md-6">
                ...
                <form action="{{ url('catalogo/tipo_cobro') }}" method="POST">
                    @csrf
