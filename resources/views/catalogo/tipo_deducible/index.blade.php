...
<div class="modal fade" id="modal-create" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" action="{{ url('catalogo/tipo_deducible') }}">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Nuevo tipo de deducible</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label>Nombre</label>
                        <input type="text" name="Nombre" class="form-control" value="{{ old('Nombre') }}" maxlength="45" required
...
@foreach ($tipo_deducible as $obj)
    <div class="modal fade" id="modal-edit-{{ $obj->Id }}" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" action="{{ url('catalogo/tipo_deducible/' . $obj->Id) }}">
                @csrf
                @method('PUT')
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Editar tipo de deducible</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Nombre</label>
                            <input type="text" name="Nombre" class="form-control" value="{{ old('Nombre', $obj->Nombre) }}" maxlength="45" required
                                oninput="let s=this.selectionStart,e=this.selectionEnd;this.value=this.value.toUpperCase();this.setSelectionRange(s,e)">
                        </div>
                    </div>
                    <div class="modal-footer">
            ...
            <form method="POST" action="{{ url('catalogo/tipo_deducible/' . $obj->Id) }}">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Eliminar tipo de deducible</h4>
                    </div>
                    <div class="modal-body">
