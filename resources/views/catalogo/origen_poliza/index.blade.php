...
<div class="modal fade" id="modal-create" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" action="{{ url('catalogo/origen_poliza') }}">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Nuevo origen de poliza</h4>
                </div>
...
@foreach ($origen_poliza as $obj)
    <div class="modal fade" id="modal-edit-{{ $obj->Id }}" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" action="{{ url('catalogo/origen_poliza/' . $obj->Id) }}">
                @csrf
                @method('PUT')
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Editar origen de poliza</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Nombre</label>
            ...
            <form method="POST" action="{{ url('catalogo/origen_poliza/' . $obj->Id) }}">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Eliminar origen de poliza</h4>
                    </div>
                    <div class="modal-body">
