...
@can('gestion-aseguradora edit')
    ...
    <div class="x_panel">
                ...
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                        <li role="presentation" class="{{ $tab == 1 ? 'active' : '' }}"><a href="#cliente" id="home-tab"
                                role="tab" data-toggle="tab" aria-expanded="true">Aseguradora</a>

                        </li>
                        <li role="presentation" class="{{ $tab == 2 ? 'active' : '' }}"><a href="#redes" role="tab"
                                id="profile-necesidad" data-toggle="tab" aria-expanded="false">Contactos
                                frecuentes</a>
                        </li>
                    ...
                    <div id="myTabContent2" class="tab-content">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" name="Nombre" value="{{ $aseguradora->Id }}"
                                                class="form-control" readonly autofocus="true">
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="row" style="padding-top: 15px!important;">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" name="PaginaWeb" value="{{ $aseguradora->PaginaWeb }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="row" style="padding-top: 15px!important;">
                                    ...
                                    <div class="row" style="padding-top: 15px!important;">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" name="Nombre"
                                                value="{{ strtoupper($aseguradora->Nombre) }}" class="form-control"
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <textarea name="Direccion" rows="1" class="form-control"
                                                oninput="let s=this.selectionStart,e=this.selectionEnd;this.value=this.value.toUpperCase();this.setSelectionRange(s,e)">{{ strtoupper($aseguradora->Direccion) }}</textarea>
                                        </div>
                                    </div>
                                    <div class="row" style="padding-top: 15px!important;">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" name="Abreviatura"
                                                value="{{ strtoupper($aseguradora->Abreviatura) }}" class="form-control"
                                                oninput="let s=this.selectionStart,e=this.selectionEnd;this.value=this.value.toUpperCase();this.setSelectionRange(s,e)">
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="row" style="padding-top: 15px!important;">
                                        <div class="col-md-6">
                                            ...
                                            <select id="Distrito" name="Distrito" required class="form-control select2"
                                                style="width: 100%">
                                                @foreach ($distritos as $obj)
                                                    <option value="{{ $obj->Id }}"
                                                        {{ $aseguradora->Distrito == $obj->Id ? 'selected' : '' }}>
                                                        {{ $obj->Nombre }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <label class="switch">
                                                <input type="checkbox" name="Diario" id="Diario"
                                                    onclick="dias_365(this.value)"
                                                    @if ($aseguradora->Diario == 1) checked @endif>
                                                <span class="slider round"></span>
                                            </label>
                                        </div>
                                        <div class="col-sm-3" id="diario_365"
                                            style="display: {{ $aseguradora->Diario == 1 ? 'block' : 'none' }};">
                        ...
                        <div role="tabpanel" class="tab-pane fade {{ $tab == 2 ? 'active in' : '' }}" id="redes"
                            aria-labelledby="home-tab">
                        ...
                        <div role="tabpanel" class="tab-pane fade {{ $tab == 3 ? 'active in' : '' }}" id="necesidad"
                            aria-labelledby="home-tab">
                        ...
                        <div role="tabpanel" class="tab-pane fade {{ $tab == 4 ? 'active in' : '' }}" id="documentacion"
                            aria-labelledby="home-tab">
                            <form id="FormArchivo" action="{{ url('catalogo/aseguradora/documento') }}" method="POST"
                                    ...
                                    <table class=" table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            @foreach ($documentos as $obj)
                                                <tr>
                                                    <td><a href="{{ asset('documentos/aseguradoras') }}/{{ $obj->Nombre }}"
                                                ...
                                                <div class="modal fade modal-slide-in-right" aria-hidden="true"
                                                    ...
                                                    <form method="POST"
                                                        action="{{ url('catalogo/aseguradora/documento_eliminar', $obj->Id) }}">
                                                        @method('post')
                                                        @csrf
        ...
        <div class="modal fade" id="modal_addCargo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            displayOption("ul-aseguradoras", "li-catalogo-aseguradora");
