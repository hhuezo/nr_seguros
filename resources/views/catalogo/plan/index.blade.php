...
<div class="x_panel">
    ...
    <div class="x_title">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12" align="right">
            <a href="{{ url('catalogo/plan/create/') }}"><button class="btn btn-info float-right"> <i class="fa fa-plus"></i> Nuevo</button></a>
        </div>
            ...
            <table id="datatable" class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            @can('edit users')
                            <a href="{{ url('catalogo/plan') }}/{{ $obj->Id }}/edit" class="on-default edit-row">
