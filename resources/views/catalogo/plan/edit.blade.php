            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-horizontal form-label-left">
                ...
                <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        <a href="{{ url('catalogo/plan') }}?idRegistro={{ $plan->Id }}" class="btn btn-info fa fa-undo "
                            ...
                            <div class="col-sm-6">
                                ...
                                <select id="Producto" name="Producto" class="form-control select2" style="width: 100%">
                                    @foreach ($productos as $obj)
                                        <option value="{{ $obj->Id }}"
                                            {{ $plan->ProductoId == $obj->Id ? 'selected' : '' }}>{{ $obj->Nombre }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <i class="fa fa-pencil fa-lg"
                                            onclick="modal_edit_cobertura({{ $obj->Id }},'{{ $obj->Nombre }}','{{ $obj->pivot->SumaAsegurada }}','{{ $obj->pivot->Tasa }}','{{ $obj->pivot->Prima }}')"
                            ...
                            @foreach ($coberturasDisponibles as $obj)
                                <tr>
                                    ...
                                    <td>
                                        <i class="fa fa-pencil fa-lg"
                                            onclick="modal_edit_cobertura({{ $obj->Id }},'{{ $obj->Nombre }}','0','0','0')"
                                            data-target="#modal-edit-cobertura" data-toggle="modal"></i>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <div class="col-sm-6">
                                        Cobertura
                                        <input disabled type="text" name="Nombre" id="ModalCoberturaNombre"
                                            class="form-control" required>
                                    </div>
                                    <div class="col-sm-6">
                                        Suma Asegurada
                                        <input type="number" name="SumaAsegurada" id="ModalCoberturaSumaAsegurada"
                                            step="0.01" class="form-control" required>
                                    </div>
                                    <div class="col-sm-6">
                                        Tasa
                                        <input type="number" name="Tasa" id="ModalCoberturaTasa" step="0.01"
                                            class="form-control" required>
                                    </div>
                                    <div class="col-sm-6">
                                        Prima
                                        <input type="number" name="Prima" id="ModalCoberturaPrima" step="0.01"
                                            class="form-control" required>
                                    </div>
                                </div>
                            </div>
