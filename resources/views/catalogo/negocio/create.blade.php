                    ...
                    <div class="x_content">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                    <input type="date" name="FechaVenta" value="{{ old('FechaVenta') }}"
                                        class="form-control">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                    <input type="date" name="InicioVigencia" value="{{ old('InicioVigencia') }}"
                                        class="form-control">
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                    <input type="number" step="0.01" name="SumaAsegurada"
                                        value="{{ old('SumaAsegurada') }}" class="form-control">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                    <input type="number" step="0.01" name="Prima" value="{{ old('Prima') }}"
                                        class="form-control">
                                </div>
                            </div>
