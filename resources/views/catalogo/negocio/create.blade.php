            ...
            <form action="{{ url('catalogo/negocio') }}" method="POST" class="forms-sample">
                ...
                <div class="x_content">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="x_panel">
                            <div class="x_title">
                                <h5>Tabla de Aseguradoras<small></small></h5>
                                <div class="float-right" style="text-align: right;"> <button type="button" onclick="modal_aseguradora()" class="btn btn-primary"><i class="fa fa-plus"></i></button></div>
                                <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
