                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="TipoPersona" id="TipoPersona" onchange="validaciones.cboTipoPersona(this.value)" required class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="Nit" id="Nit" value="{{ old('Nit') }}" data-inputmask="'mask': ['9999-999999-999-9']" data-mask type="text" required>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="RegistroFiscal" id="RegistroFiscal" required value="{{ old('RegistroFiscal') }}" type="text">
                                </div>
                                <div class="form-group">
                                    <label for="Nombre" class="form-label">Nombre o Razón Social *</label>
                                    <input class="form-control" id="Nombre" name="Nombre" value="{{ old('Nombre') }}" type="text" required>
                                </div>
                                <div class="form-group">
                                    <label for="FechaNacimiento" class="form-label">Fecha de Nacimiento ó Fundación *</label>
                                    <input class="form-control" name="FechaNacimiento" id="FechaNacimiento" required value="{{ old('FechaNacimiento') }}" type="date">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="NumeroDependientes" id="NumeroDependientes" value="{{ old('NumeroDependientes') }}" min="0" type="number" style="display: block;">
                                </div>
                                <div class="form-group">
                                    <label for="Genero" class="form-label">Ocupación</label>
                                    <input class="form-control" id="Ocupacion" name="Ocupacion" value="{{ old('Ocupacion') }}" required type="text">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="TelefonoCelular" value="{{ old('TelefonoCelular') }}" required data-inputmask="'mask': ['9999-9999']" data-mask type="text">
                                </div>
                                <div class="form-group">
                                    <label for="Referencia" class="form-label">Teléfono Residencia</label>
                                    <input class="form-control" name="TelefonoResidencia" id="TelefonoResidencia" value="{{ old('TelefonoResidencia') }}" data-inputmask="'mask': ['9999-9999']" data-mask type="text" style="display: block;">
                                </div>
                                <div class="form-group">
                                    <label for="Referencia" class="form-label">Teléfono Oficina *</label>
                                    <input class="form-control" name="TelefonoOficina" value="{{ old('TelefonoOficina') }}" required data-inputmask="'mask': ['9999-9999']" data-mask type="text">
                                </div>
                                <div class="form-group">
                                    <label for="TelefonoCelular2" class="form-label">Teléfono Celular *</label>
                                    <input class="form-control" name="TelefonoCelular2" value="{{ old('TelefonoCelular2') }}" required data-inputmask="'mask': ['9999-9999']" data-mask type="text">
                                </div>
                                <div class="form-group">
                                    <label for="CorreoPrincipal" class="form-label">Correo Principal *</label>
                                    <input class="form-control" name="CorreoPrincipal" value="{{ old('CorreoPrincipal') }}" type="email" required>
                                </div>
                                <div class="form-group">
                                    <label for="CorreoPrincipal" class="form-label">Correo Secundario *</label>
                                    <input class="form-control" name="CorreoSecundario" value="{{ old('CorreoPrincipal') }}" type="email" required>
                                </div>
                                <div class="form-group">
                                    <label for="FechaVinculacion" class="form-label">Fecha Vinculación *</label>
                                    <input class="form-control" name="FechaVinculacion" value="{{ old('FechaVinculacion') }}" type="date" required>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="TipoContribuyente" id="TipoContribuyente" required class="form-control" onchange="validaciones.cboTipoContribuyente(this.value)" style="width: 100%">
                                ...
                                <div class="form-group" style="padding-bottom: 90px!important;">
                                    ...
                                    <input class="form-control" name="Referencia" id="Referencia" required value="{{ old('Referencia') }}" type="text">
                                </div>
                                ...
                                <div class="campo-container">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="ResponsablePago" name="ResponsablePago" required value="{{ old('ResponsablePago') }}" type="text">
                                    </div>
                                  <div class="form-group">
                                    <label for="Genero" class="form-label">Ubicación de cobro * </label>
                                    <select name="UbicacionCobro" class="form-control" style="width: 100%" required>
                                        <option value="" selected disabled>Seleccione ...</option>
                                    ...
                                    <div class="campo-container">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="Departamento" class="form-control select2" style="width: 100%" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="Distrito" name="Distrito" class="form-control select2" style="width: 100%" required disabled>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="BancoPrefencia" value="{{ old('BancoPrefencia') }}" required type="text">
                                        </div>
                                        <div class="form-group">
                                            <label for="CuentasDevolucionPrimas" class="form-label">Cuentas para devolución de Primas * </label>
                                            <input class="form-control" name="CuentasDevolucionPrimas" value="{{ old('CuentasDevolucionPrimas') }}" required  type="text">
                                        </div>
                                    </div>
                                </div>
