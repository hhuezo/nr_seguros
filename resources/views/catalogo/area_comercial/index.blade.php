                ...
                <table id="datatable" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        @foreach ($area_comercial as $obj)
                            ...
                            @include('catalogo.area_comercial.edit')
                        @endforeach
                    </tbody>
                </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-md-6">
                        <h4 class="modal-title">Nueva Área Comercial</h4>
                    </div>
                    <div class="col-md-6">
                ...
                <form action="{{ url('catalogo/area_comercial') }}" method="POST">
                    @csrf
