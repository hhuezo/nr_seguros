                ...
                <table id="datatable" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        @foreach ($agrupadores as $obj)
                            ...
                            @include('catalogo.agrupador_ramo.modal')
                            @include('catalogo.agrupador_ramo.edit')
                        @endforeach
                    </tbody>
                </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-md-6">
                        <h4 class="modal-title">Nuevo Agrupador</h4>
                    </div>
                    <div class="col-md-6">
                ...
                <form action="{{ url('catalogo/agrupador_ramo') }}" method="POST">
                    @csrf
