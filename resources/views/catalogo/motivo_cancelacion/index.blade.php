...
<div class="modal fade" id="modal-create" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" action="{{ url('catalogo/motivo_cancelacion') }}">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Nuevo motivo de cancelacion</h4>
                </div>
...
@foreach ($motivos_cancelacion as $obj)
    <div class="modal fade" id="modal-edit-{{ $obj->Id }}" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" action="{{ url('catalogo/motivo_cancelacion/' . $obj->Id) }}">
                @csrf
                @method('PUT')
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Editar motivo de cancelacion</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Nombre</label>
            ...
            <form method="POST" action="{{ url('catalogo/motivo_cancelacion/' . $obj->Id) }}">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Eliminar motivo de cancelacion</h4>
                    </div>
                    <div class="modal-body">
