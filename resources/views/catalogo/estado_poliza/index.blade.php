    ...
    <div class="x_panel">
        ...
        <div class="x_title">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <h3>Estado de Póliza</h3>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-12" align="right">
                @can('estado-polizas create')
                ...
                <table id="datatable" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        @foreach ($estado_poliza as $obj)
                            ...
                            @include('catalogo.estado_poliza.edit')
                        @endforeach
                    </tbody>
                </table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="col-md-6">
                        <h4 class="modal-title">Nuevo Estado de Póliza</h4>
                    </div>
                    <div class="col-md-6">
                ...
                <form action="{{ url('catalogo/estado_polizas') }}" method="POST">
                    @csrf
