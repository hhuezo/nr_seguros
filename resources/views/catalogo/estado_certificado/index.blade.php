...
<div class="x_panel">
    ...
    <div class="x_content">
        ...
        <table id="datatable" class="table table-striped table-bordered" style="width:100%;">
            ...
            <tbody>
                @foreach ($estados_certificado as $obj)
                    <tr>
...
<div class="modal fade" id="modal-create" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <form method="POST" action="{{ url('catalogo/estado_certificado') }}">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Nuevo estado de certificado</h4>
                </div>
...
@foreach ($estados_certificado as $obj)
    <div class="modal fade" id="modal-edit-{{ $obj->Id }}" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" action="{{ url('catalogo/estado_certificado/' . $obj->Id) }}">
                @csrf
                @method('PUT')
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Editar estado de certificado</h4>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Nombre</label>
            ...
            <form method="POST" action="{{ url('catalogo/estado_certificado/' . $obj->Id) }}">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Eliminar estado de certificado</h4>
                    </div>
                    <div class="modal-body">
