...
use App\Http\Controllers\catalogo\CesionarioController;
...
use App\Http\Controllers\catalogo\EstadoCertificadoController;
use App\Http\Controllers\catalogo\EstadoVentaController;
use App\Http\Controllers\catalogo\FormaPagoPolizaController;
...
use App\Http\Controllers\catalogo\ParentescoBeneficiarioController;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::resource('catalogo/estado_certificado', EstadoCertificadoController::class);
    ...
    Route::resource('catalogo/forma_pago_polizas', FormaPagoPolizaController::class);
    Route::resource('catalogo/origen_poliza', OrigenPolizaController::class);
    Route::resource('catalogo/parentesco_beneficiario', ParentescoBeneficiarioController::class);
    Route::resource('catalogo/cesionario', CesionarioController::class);
    ...
    Route::get('poliza/seguro/{id}/export_certificados', [PolizaSeguroController::class, 'export_certificados']);
    Route::get('poliza/seguro/{id}/certificado/create', [PolizaSeguroController::class, 'certificado_create']);
    Route::get('poliza/seguro/certificado/{id}/edit', [PolizaSeguroController::class, 'certificado_edit']);
    ...
    Route::post('poliza/seguro/certificado_detalle_save/{id}', [PolizaSeguroController::class, 'certificado_detalle_save']);
    Route::post('poliza/seguro/certificado_sumas_save/{id}', [PolizaSeguroController::class, 'certificado_sumas_save']);
    Route::post('poliza/seguro/certificado_datos_tecnicos_save/{id}', [PolizaSeguroController::class, 'certificado_datos_tecnicos_save']);
    ...
    Route::post('poliza/seguro/certificado_beneficiario_store/{id}', [PolizaSeguroController::class, 'certificado_beneficiario_store']);
    Route::post('poliza/seguro/certificado_beneficiario_update/{id}', [PolizaSeguroController::class, 'certificado_beneficiario_update']);
    Route::post('poliza/seguro/certificado_beneficiario_delete/{id}', [PolizaSeguroController::class, 'certificado_beneficiario_delete']);
    Route::post('poliza/seguro/certificado_beneficiario_toggle/{id}', [PolizaSeguroController::class, 'certificado_beneficiario_toggle']);
    Route::post('poliza/seguro/certificado_cesion_beneficios_store/{id}', [PolizaSeguroController::class, 'certificado_cesion_beneficios_store']);
    Route::post('poliza/seguro/certificado_cesion_beneficios_update/{id}', [PolizaSeguroController::class, 'certificado_cesion_beneficios_update']);
    Route::post('poliza/seguro/certificado_cesion_beneficios_delete/{id}', [PolizaSeguroController::class, 'certificado_cesion_beneficios_delete']);
    Route::post('poliza/seguro/certificado_cesion_beneficios_toggle/{id}', [PolizaSeguroController::class, 'certificado_cesion_beneficios_toggle']);
