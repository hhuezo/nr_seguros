        ...
        if ($tipoPoliza == 1) {
         ...
         ========================= */
            ...
            $vida = DB::table('poliza_declarativa_control')
                ...
                ->leftJoin('poliza_vida_detalle_preliminar', function ($join) use ($anio, $mes) {
                    $join->on('poliza_vida_detalle_preliminar.PolizaVidaId', '=', 'poliza_vida.Id')
                        ->where('poliza_vida_detalle_preliminar.Axo', $anio)
                        ->where('poliza_vida_detalle_preliminar.Mes', $mes);
                })
                ...
                ->select(
                    ...
                    // COALESCE ajustados: Si el campo no existe en poliza_vida_detalle, solo traemos el de la preliminar
                    DB::raw('COALESCE(poliza_vida_detalle.MontoCartera, poliza_vida_detalle_preliminar.MontoCartera) as MontoCartera'),

                    // Aquí estaba el error: poliza_vida_detalle no tiene 'Tasa' ni 'Iva', así que los tomamos directo de la preliminar
                    DB::raw('poliza_vida_detalle_preliminar.Tasa as Tasa'),
                    DB::raw('poliza_vida_detalle_preliminar.Iva as Iva'),

                    DB::raw('COALESCE(poliza_vida_detalle.PrimaCalculada, poliza_vida_detalle_preliminar.PrimaCalculada) as PrimaCalculada'),
                    DB::raw('COALESCE(poliza_vida_detalle.ExtraPrima, poliza_vida_detalle_preliminar.ExtraPrima) as ExtraPrima'),
                    DB::raw('COALESCE(poliza_vida_detalle.PrimaDescontada, poliza_vida_detalle_preliminar.PrimaDescontada) as PrimaDescontada'),
                    DB::raw('COALESCE(poliza_vida_detalle.TasaComision, poliza_vida_detalle_preliminar.TasaComision) as TasaComision'),
                    DB::raw('COALESCE(poliza_vida_detalle.Comision, poliza_vida_detalle_preliminar.Comision) as Comision'),
                    DB::raw('COALESCE(poliza_vida_detalle.Retencion, poliza_vida_detalle_preliminar.Retencion) as Retencion'),
                    DB::raw('COALESCE(poliza_vida_detalle.IvaSobreComision, poliza_vida_detalle_preliminar.IvaSobreComision) as IvaSobreComision'),
                    DB::raw('COALESCE(poliza_vida_detalle.APagar, poliza_vida_detalle_preliminar.APagar) as APagar'),
                    DB::raw('COALESCE(poliza_vida_detalle.NumeroRecibo, poliza_vida_detalle_preliminar.NumeroRecibo) as NumeroRecibo'),
                    DB::raw('COALESCE(poliza_vida_detalle.Axo, poliza_vida_detalle_preliminar.Axo) as Axo'),
                    DB::raw('COALESCE(poliza_vida_detalle.FechaInicio, poliza_vida_detalle_preliminar.FechaInicio) as FechaInicio'),
                    DB::raw('COALESCE(poliza_vida_detalle.Usuario, poliza_vida_detalle_preliminar.Usuario) as Usuario'),
                    DB::raw('COALESCE(poliza_vida_detalle.UsuariosReportados, poliza_vida_detalle_preliminar.UsuariosReportados) as UsuariosReportados'),
