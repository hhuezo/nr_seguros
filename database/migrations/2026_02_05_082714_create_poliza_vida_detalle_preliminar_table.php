...
return new class extends Migration
{
    ...
    {
        Schema::create('poliza_vida_detalle_preliminar', function (Blueprint $table) {
            $table->bigIncrements('Id');
            $table->unsignedBigInteger('PolizaVidaId');
            $table->integer('Axo');
            $table->integer('Mes');
            ...
            $table->index('PolizaVidaId');
            $table->index(['Axo', 'Mes']);

            // Foreign key si existe la tabla poliza_vida
            $table->foreign('PolizaVidaId')->references('Id')->on('poliza_vida')->onDelete('restrict');
        });
    }
    ...
    {
        Schema::dropIfExists('poliza_vida_detalle_preliminar');
    }
};
